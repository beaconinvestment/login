            ...
            <div class="col-md-6 col-sm-6" id="address_margt">
                <div class="media media-right">
                    ...
                    <div class="media-body">
                        ...
                        <div class="danger">Beacon Investment</div>
                        <address>
                            Office # 26, Third Floor,
                            <br> Al-Hameed Mall,
                            <br> Markaz G-11, Islamabad,
                            <br> Capital Territory, Pakistan
                        </address>
                    </div>
                </div>
                <div class="media padleft10">
                    ...
                    <div class="media-body padbtm2">
                        <h4 class="media-heading">Telephone:</h4> +92 334 5054117
                        {{--<br /> Fax:400 423 1456--}}
                    </div>
                </div>
            </div>
