...
<?php $__env->startSection('header_styles'); ?>
    ...
    <link href="<?php echo e(asset('assets/vendors/jquery_steps/css/jquery.steps.css')); ?>" rel="stylesheet"/>
    <link href="<?php echo e(asset('assets/css/pages/custom_gui_builder.css')); ?>" rel="stylesheet"/>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script language="javascript" type="text/javascript" src="<?php echo e(asset('assets/vendors/iCheck/js/icheck.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/vendors/jquery_steps/js/jquery.steps.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/pluginjs/validate.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/pages/custom_gui_builder.js')); ?>"></script>
    ...
    <script>
        ...
        var modelCheckUrl = "<?php echo e(url('admin/modelCheck')); ?>";
        var generateUrl = "<?php echo url(''); ?>/admin/generator_builder/generate";
        var componentUrl = "<?php echo url(''); ?>/admin/field_template";
