                        ...
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-md-offset-4">
                                    ...
                                    <div> <b class="margin_right15"> <?php echo e($min_id); ?> </b>
                                        <input id="id_range" type="text" data-slider-id='id_range' class="slider form-control" data-slider-handle="square" value="" data-slider-min="<?php echo e($min_id); ?>" data-slider-max="<?php echo e($max_id); ?>" data-slider-step="1" data-slider-value="[<?php echo e($min_id); ?>,<?php echo e($max_id); ?>]"/> <b style="margin-left: 15px;"><?php if(!empty($max_count)): ?><?php echo e($max_id); ?> <?php else: ?> 10 <?php endif; ?></b>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="col-md-4 col-md-offset-4">
                                ...
                                <?php echo Form::select('professions', $professions , null,['class' => 'form-control', 'id' => 'professions', 'placeholder' => 'Please Select One...']); ?>
                            ...
                            <div class="panel panel-primary filterable">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div> <b class="margin_right15"><?php echo e($min_id); ?></b>
                                            <input id="id_range2" type="text" data-slider-id='id_range' class="slider form-control" dusk="slide_range" data-slider-handle="square" value="" data-slider-min="<?php echo e($min_id); ?>" data-slider-max="<?php echo e($max_id); ?>" data-slider-step="1" data-slider-value="[<?php echo e($min_id); ?>,<?php echo e($max_id); ?>]"/> <b style="margin-left: 15px;"><?php if(!empty($max_count)): ?><?php echo e($max_id); ?> <?php else: ?> 10 <?php endif; ?></b>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <label class="control-label">Profession :</label>
                                        <?php echo Form::select('professions', $professions, null,['class' => 'form-control', 'id' => 'professions2', 'placeholder' => 'Please Select One...']); ?>
