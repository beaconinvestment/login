...
<?php $__env->startSection('header_styles'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/pages/minisidebar.css')); ?>"/>
            ...
            <div class="col-md-12 news-page">
                ...
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <div class="news-blocks">
                            <h3>
                                <a href="<?php echo e(URL::to('admin/news_item')); ?>">Older Stories go lower</a>
                            </h3>
                            ...
                            <a href="<?php echo e(URL::to('admin/news_item')); ?>" class="news-block-btn">
                                Read more
                        ...
                        <div class="news-blocks">
                            <h3>
                                <a href="<?php echo e(URL::to('admin/news_item')); ?>">U.S. surges past Canada at World Lacrosse games</a>
                            </h3>
                    ...
                    <div class="col-md-3">
                        <div class="news-blocks">
                            <h3>
                                <a href="<?php echo e(URL::to('admin/news_item')); ?>">Futures Game: Gallo gives US 3-2 win over World</a>
                            </h3>
                        ...
                        <div class="news-blocks">
                            <h3>
                                <a href="<?php echo e(URL::to('admin/news_item')); ?>">World Cup 2014: 11 things the tournament taught us</a>
                            </h3>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="news-blocks">
                            <h3>
                                <a href="<?php echo e(URL::to('admin/news_item')); ?>">Egypt proposes Israel-Gaza ceasefire</a>
                            </h3>
                        ...
                        <div class="news-blocks">
                            <h3>
                                <a href="<?php echo e(URL::to('admin/news_item')); ?>">Hague quits as foreign secretary</a>
                            </h3>
                    ...
                    <div class="col-md-3">
                        <div class="news-blocks">
                            <h3>
                                <a href="<?php echo e(URL::to('admin/news_item')); ?>">Murder victim's family want answers</a>
                            </h3>
                        ...
                        <div class="news-blocks">
                            <h3>
                                <a href="<?php echo e(URL::to('admin/news_item')); ?>">Brooks Irish shows will not go ahead</a>
                            </h3>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="news-blocks">
                                    <h3>
                                        <a href="<?php echo e(URL::to('admin/news_item')); ?>">Dying patients 'bewildered by array of services'</a>
                                    </h3>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="news-blocks">
                                    <h3>
                                        <a href="<?php echo e(URL::to('admin/news_item')); ?>">All aboard: China's railway dream</a>
                                    </h3>
                            ...
                            <div class="col-md-6">
                                <div class="news-blocks">
                                    <h3>
                                        <a href="<?php echo e(URL::to('admin/news_item')); ?>">Record number of data complaints made to ICO</a>
                                    </h3>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/pages/minisidebar.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('admin/layouts/minisidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>