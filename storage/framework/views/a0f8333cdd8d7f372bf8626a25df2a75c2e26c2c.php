...
<?php $__env->startSection('top'); ?>
    ...
    <div id="owl-demo" class="owl-carousel owl-theme">
        <div class="item"><img src="<?php echo e(asset('assets/images/Slide_Beacon.jpg')); ?>" alt="slider-image">
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 wow zoomIn" data-wow-duration="2s">
                    <div class="layout-image">
                        <img src="<?php echo e(asset('assets/images/capital-smart-city-islamabad-1505910349-image-2-actual.jpg')); ?>" alt="layout" class="img-responsive" />
                    </div>
                </div>
                <div style="margin-top:-50px;" class="col-md-3 col-sm-3 col-xs-12 wow lightSpeedIn" data-wow-duration="2s">
                    <ul class="list-unstyled pull-right text-right layout-styl">
                        <li><img src="<?php echo e(asset('assets/images/Capital1.jpg')); ?>" alt="layout" class="img-responsive" /></li>
                        <li><img src="<?php echo e(asset('assets/images/Capital2.jpg')); ?>" alt="layout" class="img-responsive" /></li>
                        <li><img src="<?php echo e(asset('assets/images/Capital3.jpg')); ?>" alt="layout" class="img-responsive" /></li>
    ...
    <div class="container">
        ...
        <div class="row text-center">
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInLeft"  data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail bg-white">
                    <img src="<?php echo e(asset('assets/images/team-beacon-01-189x189.jpg')); ?>" alt="team-image" class="img-responsive">
                    <div class="caption">
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInUp" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail bg-white">
                    <img src="<?php echo e(asset('assets/images/team-beacon-02-189x189.jpg')); ?>" alt="team-image">
                    <div class="caption">
                        <b>Shahid Mehmood </b>
                        <p class="text-center"> Chief Executive Officer</p>
                        <div class="divide">
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInDown" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail bg-white">
                    <img src="<?php echo e(asset('assets/images/team-beacon-04-189x189.jpg')); ?>" alt="team-image" class="img-responsive">
                    <div class="caption">
                        <b>Sehban Tariq</b>
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInRight" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail bg-white">
                    <img src="<?php echo e(asset('assets/images/team-beacon-03-189x189.jpg')); ?>" alt="team-image">
                    <div class="caption">
                        <b>Zain Tariq</b>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 wow zoomInLeft" data-wow-duration="3s">
                ...
                <img src="<?php echo e(asset('assets/images/Capital-Smart-City-Islamabad.jpg')); ?>" alt="image_12" class="img-responsive">
                <p>
            ...
            <div class="col-md-6 col-sm-6 wow zoomInRight" data-wow-duration="3s">
                ...
                <img src="<?php echo e(asset('assets/images/biex2.jpg')); ?>" alt="image_11" class="img-responsive">
                <p>
