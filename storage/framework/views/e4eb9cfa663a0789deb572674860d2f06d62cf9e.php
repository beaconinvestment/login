...
<?php $__env->startSection('header_styles'); ?>
    ...
    <link rel="stylesheet" type="text/css"
          href="<?php echo e(asset('assets/vendors/datatables/css/colReorder.bootstrap.css')); ?>"/>
    <link rel="stylesheet" type="text/css"
          href="<?php echo e(asset('assets/vendors/datatables/css/dataTables.bootstrap.css')); ?>"/>
    <link rel="stylesheet" type="text/css"
          href="<?php echo e(asset('assets/vendors/datatables/css/rowReorder.bootstrap.css')); ?>"/>
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/vendors/datatables/css/buttons.bootstrap.css')); ?>">
        ...
        $( document ).ready(function() {
            $(function () {
                ...
                var table = $('#sample_editable_1').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '<?php echo route('admin.editable_datatables.data'); ?>',
                    columns: [
                        {data: 'id', name: 'id'},
