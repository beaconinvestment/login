    ...
    <div class="breadcum">
        <div class="container">
            ...
            <div class="pull-right">
                ...
                <a href="<?php echo e(URL::to('admin/news/create')); ?>"> News</a>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_default_1">
                                <?php $__empty_1 = true; $__currentLoopData = $popular; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $populars): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <a href="#">
                                                <h5 class="media-heading "><?php echo substr(strip_tags($populars->content), 0, 150); ?></h5></a>
                                            <span class="text-danger"><?php echo date('d-m-Y', strtotime($populars->created_at)); ?></span>
                            ...
                            <div class="tab-pane" id="tab_default_2">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <a href="#">
                                            <h5 class="media-heading "><?php echo substr(strip_tags($recentnew->content), 0, 150); ?></h5></a>
                                            <span class="text-danger"><?php echo date('d-m-Y', strtotime($recentnew->created_at)); ?></span>
