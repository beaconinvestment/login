                            ...
                            <div class="media">
                                <div class="media-left">
                                    <?php if($blog->author->pic): ?>
                                        <img src="<?php echo url('/').'/uploads/users/'.$blog->author->pic; ?>" class="media-object img-circle" >
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('assets/images/authors/no_avatar.jpg')); ?>" class="media-object img-circle" >
                                    <?php endif; ?>
                                </div>
                                <div class="media-body">
                                    ...
                                    <p>category:  <?php echo e($blog->category->title); ?> <span class="user_create_date pull-right">by  <?php echo e($blog->author->full_name); ?> </span></p>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
