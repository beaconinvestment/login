...
<?php $__env->startSection('header_styles'); ?>
    ...
    <link href="<?php echo e(asset('assets/css/pages/buttonbuilder2.css')); ?>" rel="stylesheet"/>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/js/pages/scripts.min.js')); ?>"  type="text/javascript"></script>
    <script src="<?php echo e(asset('assets/vendors/underscore/js/underscore-min.js')); ?>"  type="text/javascript"></script>
    <script src="<?php echo e(asset('assets/vendors/backbone/js/backbone-min.js')); ?>"  type="text/javascript"></script>
    <script src="<?php echo e(asset('assets/js/pages/buttonbuilder.js')); ?>"  type="text/javascript"></script>
