        ...
        <div class="col-lg-12">
            <div class="panel panel-primary ">
                ...
                <div class="panel-body">
                    <?php if($role): ?>
                        <?php echo Form::model($role, ['url' => URL::to('admin/groups/'. $role->id), 'method' => 'put', 'class' => 'form-horizontal']); ?>
                    ...
                    <?php else: ?>
                        <h1><?php echo app('translator')->getFromJson('groups/message.error.no_role_exists'); ?></h1>
                            <a class="btn btn-danger" href="<?php echo e(route('admin.groups.index')); ?>">
